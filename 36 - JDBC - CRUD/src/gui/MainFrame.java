		...
		toolbar.setStringListener(new ToolbarListener() {
			...
			public void saveEventOccured() {
				...
				try {
					...
					JOptionPane.showMessageDialog(MainFrame.this, "Cannot save to the database",
			...
			public void refreshEventOccured() {
				...
				try {
					...
					JOptionPane.showMessageDialog(MainFrame.this, "Unable to load data from the database",
							"Database loading Error", JOptionPane.ERROR_MESSAGE);
				}
				tablePanel.refresh();
			}
